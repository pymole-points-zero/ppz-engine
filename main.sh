...
$current_dir/venv/bin/python3.8 $current_dir/main.py paip --field_width 5 --field_height 5 --simulations 20 --weights $current_dir/model.h5 --input_pipe $input_pipe --output_pipe $output_pipe &
